				...
				<div class="col-md-12 column">
					<div class="carousel slide" id="carousel-698850">
						<ol class="carousel-indicators">
							...
							<li data-slide-to="2" data-target="#carousel-698850" class="active">
							</li>
						</ol>
						...
						</div> <a class="left carousel-control" href="#carousel-698850" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a> <a class="right carousel-control" href="#carousel-698850" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
					</div>
				</div>
			</div>
		</div>
