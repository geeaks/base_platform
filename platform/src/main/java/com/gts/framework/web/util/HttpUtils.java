...
public final class HttpUtils {
	...
	private final static GtsLogger logger = GtsLoggerFactory.getLogger(HttpUtils.class);
	...
	public static void main(String[] args) {
		System.out.println(HttpUtils.doGet(
		        "http://s.ucfpay.com/salary/salary/memberInfo?token=5NIVphJARzhM3TMzLnV39qsoubWcoYf4&reqId=375B1BA8090ACA47991352F3C43AAAF9&bizId=46cd8a4a-c27a-4c69-b0c8-baaff59106ca&merchantId=M200000081",
		        "UTF-8"));
		// StringUtils.startsWith("http://salary.trusdom.com/api/notify/fundTrade", "https:");
		// Map<String, String> p = new HashMap<String, String>();
		// p.put("key", "value");
		// // System.out.println(HttpUtils.doPost("https://mapi.ucfpay.com", p,
		// // "UTF-8"));
		// try {
		// HttpUtils.sendSSLPostRequest("https://mapi.ucfpay.com", p);
		// // System.out.println(HttpUtils.doPostBySign("https://mapi.ucfpay.com",
		// // "393f8229ea18f6594edb458195b2760b", "signName", p, "UTF-8",
		// // CodeType.MD5,false));
		// } catch (Exception e) {
